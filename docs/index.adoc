...
NOTE: Cached objects are stored by reference. Modifying an object after storing it, or modifying an object retrieved from the cache, will affect the cached value. Deep clone the object if immutability is required.
