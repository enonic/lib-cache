...
NOTE: Cached objects are returned by reference. Modifying a retrieved object will affect the cached value. Deep clone the object if immutability is required.
